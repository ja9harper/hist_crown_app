...
place = Place.create(name:'Susan B Elking House', address:'1375 Dean Street', image: 'susanbelkins.jpg', history: 'Construction finished in 1894.', latlng: '40.677785, -73.95187')
...
place = Place.create(name:'Chabad-Lubavitch Hasidic Movement HQ', address:'770 Eastern Parkway', image: '770Lubavitch.jpg', history: 'It was once a medical facility in the late 1800s.', latlng: '40.669439, -73.942855')
place = Place.create(name: 'Saint Gregory\'s Catholic Church', address:'224 Brooklyn Avenue', image: 'st_gregory\'s.jpg', history: 'This church as served the Catholic community of Crown Heights since 1905.', latlng: '40.67169567268225, -73.9453858137130')
